...
def train(data_settings, model_settings, train_settings):
    ...
    # emotionlessweight = y.count(0)/len(y)
    emotionlessweight = 0.9
    weightclass = [emotionlessweight/(num_outputs-1)]*(num_outputs-1)
    weightclass.insert(0,1-emotionlessweight)
