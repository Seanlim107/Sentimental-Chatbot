...
pairs_path = os.path.join('data', 'splits', 'train_pairs.json')
voc_path = os.path.join('data', 'splits', 'voc.json')

# Load pairs
with open(pairs_path, 'r', encoding='utf-8') as f:
    pairs = json.load(f)

# Load and reconstruct voc object
with open(voc_path, 'r', encoding='utf-8') as f:
    voc_dict = json.load(f)

voc = Voc("corpus_name")
voc.word2index = voc_dict['word2index']
voc.word2count = voc_dict['word2count']
voc.index2word = voc_dict['index2word']
voc.num_words = voc_dict['num_words']
voc.trimmed = voc_dict.get('trimmed', False)
